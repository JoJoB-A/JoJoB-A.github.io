// setup variables
const walkAcceleration = 2.0; // how much is added to the speed each frame
...
const maxSpeed = 11; // maximum horizontal speed, not vertical
...
const collectableWidth = 90;
const collectableHeight = 90;
let collectables = [];
...
var collectableList = {
  ...
  lebron: { image: "images/collectables/lebron-head.png" },
  curry: {image; "images/collectables/curry-head.png"},
};
